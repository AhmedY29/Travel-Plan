...
function Form() {
  ...
  return (
    <section className="form">
      <div ref={backRef} className="container">
        ...
        <div className="costs">
          <div className="input-number">
            ...
            <input
              onChange={(t) =>
                setFormDate({ ...formDate, location: t.target.value })
              }
              type="text"
              placeholder={t("destinationSelect")}
            />
          </div>
        </div>
        <div className="costs">
          <div className="input-number">
            ...
            <input
              onChange={(t) =>
                setFormDate({ ...formDate, days: t.target.value })
              }
              type="number"
              placeholder={t("daysSelect")}
              min={1}
            />
          </div>
        </div>
        ...
        <div className="costs">
          ...
          <div className="radio-group">
            <Radio
              onCh={handelCheckedWithWho}
              id={"alone"}
              name={"planWith"}
              icon={"✈️"}
              label={t("withWhoJustMe")}
            />
            <Radio
              onCh={handelCheckedWithWho}
              id={"couple"}
